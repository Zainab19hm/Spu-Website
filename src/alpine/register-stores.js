...
const pageStoreLoaders = {
    ...
    'about-accreditation': () => import('./pages/about-stores.js').then((module) => module.registerAboutStores),
    'about-why-spu': () => import('./pages/about-stores.js').then((module) => module.registerAboutStores),
    'about-quality-policy': () => import('./pages/about-stores.js').then((module) => module.registerAboutStores),
    'about-ethical-charter': () => import('./pages/about-stores.js').then((module) => module.registerAboutStores),
    'about-organizational-structure': () => import('./pages/about-stores.js').then((module) => module.registerAboutStores),
    'about-university-council': () => import('./pages/about-stores.js').then((module) => module.registerAboutStores),
    ...
    'admissions-filling-vacancies': () => import('./pages/admissions-stores.js').then((module) => module.registerAdmissionsStores),
    'admissions-graduation-exams': () => import('./pages/admissions-stores.js').then((module) => module.registerAdmissionsStores),
    'admissions-study-system': () => import('./pages/admissions-stores.js').then((module) => module.registerAdmissionsStores),
    'admissions-academic-warnings': () => import('./pages/admissions-stores.js').then((module) => module.registerAdmissionsStores),
    ...
    'services-library': () => import('./pages/services-stores.js').then((module) => module.registerServicesStores),
    'services-staff-email': () => import('./pages/services-stores.js').then((module) => module.registerServicesStores),
    'services-it-support': () => import('./pages/services-stores.js').then((module) => module.registerServicesStores),
    ...
    'campus-life-exam-instructions': () => import('./pages/exam-instructions-stores.js').then((module) => module.registerExamInstructionsStores),
    'campus-life-exam-penalties': () => import('./pages/exam-penalties-stores.js').then((module) => module.registerExamPenaltiesStores),
