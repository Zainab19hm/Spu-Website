...
const LEGACY_ASSET_ALIASES = Object.freeze({
    ...
    'images/faculty-dentistry-banner.png': '/images/spu-dentistry-logo.png',
    'images/faculty-pharmacy-banner.png': '/images/spu-pharmacy-logo.png',
    'images/faculty-ai-engineering-banner.png': '/images/spu-ai-logo.png',
    'images/faculty-construction-engineering-banner.png': '/images/spu-construction-logo.png',
    'images/faculty-petroleum-engineering-banner.png': '/images/spu-petroleum-logo.png',
    'images/faculty-admin-sciences-banner.png': '/images/spu-business-logo.png',
    'images/faculty-dentistry-logo.png': '/images/spu-dentistry-logo.png',
    'images/faculty-pharmacy-logo.png': '/images/spu-pharmacy-logo.png',
    'images/faculty-ai-engineering-logo.png': '/images/spu-ai-logo.png',
    'images/faculty-construction-engineering-logo.png': '/images/spu-construction-logo.png',
    'images/faculty-petroleum-engineering-logo.png': '/images/spu-petroleum-logo.png',
    'images/faculty-business-logo.png': '/images/spu-business-logo.png',
