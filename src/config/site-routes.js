...
export const siteRoutes = Object.freeze({
    ...
    researchConferencesRegister: getPageRoute('research-conferences-register'),
    ...
    newsEventsList: getPageRoute('news-events-list'),
    newsEventsListRegister: getPageRoute('news-events-list-register'),
    newsEventsListPast: getPageRoute('news-events-list-past'),
    ...
    campusLifeCareerDevelopmentJobsApply: getPageRoute('campus-life-career-development-jobs-apply'),
