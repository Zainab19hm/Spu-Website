...
export const statsItems = [
    ...
    {
        id: 2,
        labelAr: 'مخرجات بحثية علمية',
        labelEn: 'Scientific Research Outputs',
        summaryAr: 'أبحاث منشورة ومحكّمة، ومشاريع تطبيقية، ومشاركة في المؤتمرات العلمية عبر التخصصات.',
        summaryEn: 'Peer-reviewed work, applied projects, and conference contributions across disciplines.',
        value: 150,
        current: 0,
        svgPath: '/images/icon-award-outline.svg',
        suffixEn: '+',
        suffixAr: '+',
        accent: '#00897b',
        glow: 'rgba(0,137,123,0.2)'
    },
    {
        id: 3,
        labelAr: 'طالب وطالبة',
...
export const pathItems = [
    ...
    { id: 2, titleAr: 'الطلاب الحاليون', titleEn: 'Current Students', icon: '/images/icon-users-outline.svg', linksAr: ['بوابات الدخول', 'الجداول', 'الخدمات', 'المصادر الأكاديمية'], linksEn: ['Access portals', 'Schedules', 'Services', 'Academic resources'], actionAr: 'عرض المصادر', actionEn: 'View Student Resources' },
    { id: 3, titleAr: 'الكادر التدريسي والمنظومة', titleEn: 'Faculty & Staff', icon: '/images/icon-user-graduate-outline.svg', linksAr: ['أدوات التدريس', 'السياسات', 'الأنظمة', 'الخدمات الداخلية'], linksEn: ['Find teaching tools', 'Policies', 'Systems', 'Internal services'], actionAr: 'استكشاف المصادر', actionEn: 'Explore Resources' },
    { id: 4, titleAr: 'الخريجون', titleEn: 'Alumni', icon: '/images/flowbite_user-graduate-outline.svg', linksAr: ['خدمات الخريجين', 'الشبكة', 'الفعاليات', 'التوظيف'], linksEn: ['Alumni Services', 'Network', 'Events', 'Career'], actionAr: 'استكشاف المصادر', actionEn: 'Explore Resources' },
...
export const honorPanelItems = [
    {
        ...
        image: '/images/faculty-medicine-banner.png',
    ...
    },
    {
        ...
        image: '/images/faculty-ai-engineering-banner.png',
...
export const mockCalendarEvents = [
    ...
    { id: 3, type: 'Tour', titleEn: 'Campus Tour', titleAr: 'جولة في الحرم الجامعي', date: '2026-03-13', image: '/images/slider-3.jpg', descriptionEn: 'Guided tour of university student spaces.', descriptionAr: 'جولة إرشادية في مسارات الطلاب بالجامعة.', link: withHash(siteRoutes.contact, 'visit-campus') },
    ...
    { id: 5, type: 'Student Life', titleEn: 'Campus Clubs Fair', titleAr: 'معرض الأندية الجامعية', date: '2026-03-30', image: '/images/slider-4.jpg', descriptionEn: 'Join activities matching your interests on campus.', descriptionAr: 'انضم إلى الأنشطة التي تناسب اهتماماتك في الحرم الجامعي.', link: withHash(siteRoutes.studentLife, 'activities') },
    ...
    { id: 8, type: 'Health', titleEn: 'Free Dental Checkup Day', titleAr: 'يوم فحص الأسنان المجاني', date: '2026-04-20', image: '/images/healthcare-dental.png', descriptionEn: 'Public dental health awareness and free checkups.', descriptionAr: 'التوعية بصحة الأسنان العامة وفحوصات مجانية.', link: withHash(siteRoutes.faculties, 'faculty-2') },
    ...
    { id: 10, type: 'Talk', titleEn: 'Engineering Alumni Career Talk', titleAr: 'لقاء مهني مع خريجي الهندسة', date: '2026-04-10', image: '/images/slider-2.jpg', descriptionEn: 'Successful alumni share their career journeys with students.', descriptionAr: 'خريجون ناجحون يشاركون مساراتهم المهنية مع الطلاب.', link: siteRoutes.studentLife },
