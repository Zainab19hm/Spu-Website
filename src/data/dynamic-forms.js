export const dynamicForms = {
    'conference-registration': {
        ...
        fields: [
            ...
            {
                name: 'role', type: 'select', labelEn: 'Attendance Role', labelAr: 'دور الحضور', required: true,
                options: [
            ...
            {
                name: 'dietary', type: 'select', labelEn: 'Dietary Requirements', labelAr: 'متطلبات النظام الغذائي', required: false,
                options: [
    ...
    'symposium-registration': {
        ...
        fields: [
            ...
            {
                name: 'year', type: 'select', labelEn: 'Academic Year', labelAr: 'السنة الأكاديمية', required: true,
                options: [
    ...
    // =========================================================================
    // Multi-step form: Job Application
    // =========================================================================
    'job-application': {
        ...
        steps: [
            {
                ...
                fields: [
                    ...
                    {
                        name: 'gender', type: 'select', labelEn: 'Gender', labelAr: 'الجنس', required: true,
                        options: [
            ...
            },
            {
                ...
                fields: [
                    {
                        name: 'educationLevel', type: 'select', labelEn: 'Education Level', labelAr: 'المستوى التعليمي', required: true,
                        options: [
                            { value: '', labelEn: 'Select education level', labelAr: 'اختر المستوى التعليمي' },
                            { value: 'phd', labelEn: 'PhD', labelAr: 'دكتوراه' },
                            { value: 'master', labelEn: 'Master\'s', labelAr: 'ماجستير' },
                            { value: 'bachelor', labelEn: 'Bachelor\'s', labelAr: 'بكالوريوس' },
                            { value: 'institute', labelEn: 'Institute', labelAr: 'معهد' },
                            { value: 'none', labelEn: 'Not enrolled', labelAr: 'غير مدخول' }
                        ]
                    },
                    ...
                    {
                        name: 'englishLevel', type: 'select', labelEn: 'English Language Level', labelAr: 'مستوى اللغة الإنجليزية', required: true,
                        options: [
                            { value: '', labelEn: 'Select level', labelAr: 'اختر المستوى' },
                    ...
                    {
                        name: 'personalSkills', type: 'select', labelEn: 'Personal Skills Level', labelAr: 'مستوى المهارات الشخصية', required: false,
                        options: [
                            { value: '', labelEn: 'Select level', labelAr: 'اختر المستوى' },
            ...
            },
            {
                ...
                titleAr: 'المعلومات الأكاديمية',
                icon: 'briefcase',
                fields: [
                    {
                        name: 'targetFaculty', type: 'select', labelEn: 'Faculty to Apply To', labelAr: 'الكلية المراد التقدم لها', required: true,
                        options: [
                            { value: '', labelEn: 'Select faculty', labelAr: 'اختر الكلية' },
                            { value: 'ai', labelEn: 'Faculty of Artificial Intelligence', labelAr: 'كلية الذكاء الاصطناعي' },
                            { value: 'business', labelEn: 'Faculty of Business Administration', labelAr: 'كلية إدارة الأعمال' },
                            { value: 'construction', labelEn: 'Faculty of Building Construction Engineering', labelAr: 'كلية هندسة التشييد والبناء' },
                            { value: 'dentistry', labelEn: 'Faculty of Dentistry', labelAr: 'كلية طب الأسنان' },
                            { value: 'medicine', labelEn: 'Faculty of Medicine', labelAr: 'كلية الطب' },
                            { value: 'petroleum', labelEn: 'Faculty of Petroleum Engineering', labelAr: 'كلية هندسة النفط' },
                    ...
                    {
                        name: 'academicRank', type: 'select', labelEn: 'Academic Rank', labelAr: 'الرتبة الأكاديمية', required: true,
                        options: [
                            { value: '', labelEn: 'Select rank', labelAr: 'اختر الرتبة' },
                            { value: 'professor', labelEn: 'Professor', labelAr: 'أستاذ' },
                            { value: 'associate-professor', labelEn: 'Associate Professor', labelAr: 'أستاذ مشارك' },
                            { value: 'assistant-professor', labelEn: 'Assistant Professor', labelAr: 'أستاذ مساعد' },
                            { value: 'lecturer', labelEn: 'Lecturer', labelAr: 'محاضر' },
                            { value: 'teaching-assistant', labelEn: 'Teaching Assistant', labelAr: 'مساعد تدريس' }
                        ]
                    },
                    {
                        name: 'contractType', type: 'select', labelEn: 'Contract Type', labelAr: 'نوع التعاقد', required: true,
                        options: [
                            { value: '', labelEn: 'Select contract type', labelAr: 'اختر نوع التعاقد' },
                            { value: 'full-time', labelEn: 'Full-time', labelAr: 'دوام كامل' },
                            { value: 'part-time', labelEn: 'Part-time', labelAr: 'دوام جزئي' },
                            { value: 'visiting', labelEn: 'Visiting', labelAr: 'زائر' },
            ...
            {
                titleEn: 'CV & Documents',
                titleAr: 'السيرة الذاتية والمستندات',
                icon: 'upload',
                fields: [
            ...
            },
            {
                ...
                titleAr: 'المتطلبات الإضافية',
                icon: 'checklist',
                fields: [
                    {
                        name: 'hasPriorCriminalRecord', type: 'select', labelEn: 'Do you have any prior criminal record?', labelAr: 'هل لديك أي سجل جنائي سابق؟', required: true,
                        options: [
                    ...
                    {
                        name: 'canProvideReferences', type: 'select', labelEn: 'Can you provide professional references?', labelAr: 'هل تستطيع تقديم مراجع مهنية؟', required: true,
                        options: [
                            { value: '', labelEn: 'Select', labelAr: 'اختر' },
                            { value: 'yes', labelEn: 'Yes', labelAr: 'نعم' },
                            { value: 'no', labelEn: 'No', labelAr: 'لا' }
