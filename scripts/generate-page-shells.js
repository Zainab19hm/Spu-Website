...
const pageWarmupModules = {
  ...
  'admissions-filling-vacancies': ['/src/alpine/pages/admissions-stores.js'],
  'admissions-graduation-exams': ['/src/alpine/pages/admissions-stores.js'],
  'admissions-study-system': ['/src/alpine/pages/admissions-stores.js'],
  'admissions-academic-warnings': ['/src/alpine/pages/admissions-stores.js'],
  ...
  'center-detail': ['/src/alpine/pages/research-stores.js'],
  'research-projects': ['/src/alpine/pages/research-stores.js'],
  'research-project-detail': ['/src/alpine/pages/research-stores.js'],
  'research-publications': ['/src/alpine/pages/research-stores.js'],
  'publication-detail': ['/src/alpine/pages/research-stores.js'],
  'research-researchers': ['/src/alpine/pages/research-stores.js'],
  'researcher-profile': ['/src/alpine/pages/research-stores.js'],
  'research-themes': ['/src/alpine/pages/research-stores.js'],
  'research-theme-detail': ['/src/alpine/pages/research-stores.js'],
  // Publication slug pages
  'publication-machine-learning-pharmaceutical-quality-control': ['/src/alpine/pages/research-stores.js'],
  'publication-ai-dental-diagnostics': ['/src/alpine/pages/research-stores.js'],
  'publication-structural-analysis-earthquake-resistant-concrete': ['/src/alpine/pages/research-stores.js'],
  'publication-deep-learning-reservoir-permeability': ['/src/alpine/pages/research-stores.js'],
  'publication-clinical-simulation-training-medical-students': ['/src/alpine/pages/research-stores.js'],
  'publication-arabic-medical-record-nlp': ['/src/alpine/pages/research-stores.js'],
  'publication-business-analytics-healthcare-supply-chain': ['/src/alpine/pages/research-stores.js'],
  'publication-renewable-energy-integration-syrian-grid': ['/src/alpine/pages/research-stores.js'],
  // Theme slug pages
  'theme-ai-ml': ['/src/alpine/pages/research-stores.js'],
  'theme-pharmaceutical-sciences': ['/src/alpine/pages/research-stores.js'],
  'theme-clinical-medicine': ['/src/alpine/pages/research-stores.js'],
  'theme-dental-sciences': ['/src/alpine/pages/research-stores.js'],
  'theme-petroleum-engineering': ['/src/alpine/pages/research-stores.js'],
  'theme-construction-engineering': ['/src/alpine/pages/research-stores.js'],
  'theme-business-administration': ['/src/alpine/pages/research-stores.js'],
  'theme-medical-education': ['/src/alpine/pages/research-stores.js'],
  'theme-biomedical-engineering': ['/src/alpine/pages/research-stores.js'],
  'theme-energy-systems': ['/src/alpine/pages/research-stores.js'],
  'theme-data-science': ['/src/alpine/pages/research-stores.js'],
  'theme-structural-engineering': ['/src/alpine/pages/research-stores.js'],
  // Project slug pages
  'project-earthquake-resistant-concrete-syria': ['/src/alpine/pages/research-stores.js'],
  'project-ai-dental-diagnostics-system': ['/src/alpine/pages/research-stores.js'],
  'project-arabic-clinical-nlp-system': ['/src/alpine/pages/research-stores.js'],
  'project-pharmaceutical-quality-monitoring': ['/src/alpine/pages/research-stores.js'],
  'project-reservoir-characterization-ai': ['/src/alpine/pages/research-stores.js'],
  // Center slug pages
  'center-ai-digital-innovation': ['/src/alpine/pages/research-stores.js'],
  'center-clinical-research-simulation': ['/src/alpine/pages/research-stores.js'],
  'center-energy-sustainable-systems': ['/src/alpine/pages/research-stores.js'],
...
'faculty-dentistry-labs': ['/src/alpine/pages/faculties-page-stores.js'],
  ...
  'faculty-artificial-intelligence-study-plan': ['/src/alpine/pages/study-plan-stores.js'],
  'faculty-business-administration-study-plan': ['/src/alpine/pages/study-plan-stores.js'],
  'faculty-building-construction-engineering-study-plan': ['/src/alpine/pages/study-plan-stores.js'],
  'faculty-dentistry-study-plan': ['/src/alpine/pages/study-plan-stores.js'],
  'faculty-medicine-study-plan': ['/src/alpine/pages/study-plan-stores.js'],
  'faculty-petroleum-study-plan': ['/src/alpine/pages/study-plan-stores.js'],
  'faculty-pharmacy-study-plan': ['/src/alpine/pages/study-plan-stores.js'],
  'faculty-artificial-intelligence-course-lessons': ['/src/alpine/pages/course-lessons-stores.js'],
  'faculty-business-administration-course-lessons': ['/src/alpine/pages/course-lessons-stores.js'],
  'faculty-building-construction-engineering-course-lessons': ['/src/alpine/pages/course-lessons-stores.js'],
  'faculty-dentistry-course-lessons': ['/src/alpine/pages/course-lessons-stores.js'],
  'faculty-medicine-course-lessons': ['/src/alpine/pages/course-lessons-stores.js'],
  'faculty-petroleum-course-lessons': ['/src/alpine/pages/course-lessons-stores.js'],
  'faculty-pharmacy-course-lessons': ['/src/alpine/pages/course-lessons-stores.js'],
